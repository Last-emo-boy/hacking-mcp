...
INFORMATION_GATHERING_TOOLS: list[HackingToolDef] = [
    ...
    HackingToolDef(
        ...
        category="Information Gathering",
        install_commands=["sudo apt-get install -y python3"],
        run_command="python3 -c \"import sys, urllib.request; u='{target}'; u=u if u.startswith(('http://','https://')) else 'https://'+u; r=urllib.request.urlopen(u, timeout=10); print(f'{u} is reachable: HTTP {r.status}')\"",
    ...
    HackingToolDef(
        ...
        run_command="cd ReconDog && sudo python dog -t {target}",
    ...
    HackingToolDef(
        ...
        category="Information Gathering",
        install_commands=["git clone https://github.com/owlonex/Shodanfy.py.git"],
        run_command="cd Shodanfy.py && python3 shodanfy.py {target}",
        project_url="https://github.com/owlonex/Shodanfy.py",
