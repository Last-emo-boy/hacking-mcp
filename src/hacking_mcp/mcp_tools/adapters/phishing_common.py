"""Shared legacy phishing adapter helpers for source-unreviewed tools."""

from hacking_mcp.mcp_tools.adapter_types import AdapterParameterSpec
from hacking_mcp.mcp_tools.adapters.helpers import add_value


def phishing_parameters() -> list[AdapterParameterSpec]:
    return [
...
def phishing_options(kwargs: dict) -> list[str]:
    tokens: list[str] = []
